...
print("PLEASE ENSURE 'topteams.txt' IS IN THE SAME FOLDER AS THIS FILE FOR PROGRAM TO FUNCTION.")
sleep(2)
...
def TeamSearch():
  with open(teamlog, mode="r", encoding="UTF-8") as f:
    found = False
    filter = int(input("Please enter the variable you'd like to search for: \r\n 1: Team Name \r\n 2: Stadium \r\n 3: Team Captain \r\n 4: Nickname \r\n 5: Min. stadium capacity \r\n enter number: "))
    if filter != 5:
      ...
      for line in f:
        ...
        if stadiumCapacity >= keyword:
          ...
          found = True
      if found == True:
        print(f'Stadiums found, sorted by capacity(ascending): {sorted(results, key=lambda line: float(line.split(",")[4]), reverse=True)}')
    if found == False:
