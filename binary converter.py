...
functionDict = {1: "bin2den",2: "den2bin",3: "den2hex",4: "hex2den",5: "filesize"}#
hexstr = 'ABCDEF'
...
#recursive function, similar to the binary converter, useful to convert different base number systems, although not as useful as just hex(number)
    ...
    decin = int(input("Please enter the base 10 integer you would like to be converted: "))
    d2h(decin)
...
def filesize():
    ...
    mb = btes / 1000000
    sleep(1)
    print("COMPLETE! IMAGE STATS:\n Resolution: {} \n Bitrate: {} \n Size in Bytes: {}B \n Size in KiloBytes: {}KB\n Size in MegaBytes: {}MB".format(res, bitrate, btes, kb, mb))
headstring = "="*20 + "Binary, Hexadecimal, Image File Size Calculator".upper() + "="*20
